...
def atualizaDB():
    ...
    for i in range(71,74):
        fixtures_params = {
        'league': i, #brasileirão 71, euro copa 4, Argentina 5942, premiere league 39, la liga 140, serie b 72, CDB 73, serie A italiana 135, Bundesliga 78
        'season': 2024,
...
while True:
    ...
    if hora_atual > time(18, 00) and hora_atual < time(00,00):
        atualizaDB()
        sleep(900)
    else:
        sleep(3600)
